...
namespace TalentoPlus_S.A.S.ll.Web.Services
{
    public class PdfService : IPdfService
    {
        ...
        private void ComposeContent(IContainer container, EmployeeViewModel employee)
        {
        ...
        private void ComposePersonalData(IContainer container, EmployeeViewModel employee)
        {
            container.Column(column =>
            {
                column.Item().Row(row =>
        ...
        private void ComposeWorkData(IContainer container, EmployeeViewModel employee)
        {
            container.Column(column =>
            {
                column.Item().Row(row =>
                ...
                column.Item().PaddingTop(5).Row(row =>
                {
                    ...
                    row.RelativeItem().Element(c => ComposeField(c, "Estado:", employee.StatusDisplay));
                });
        ...
        private void ComposeEducationData(IContainer container, EmployeeViewModel employee)
        {
            container.Element(c => ComposeField(c, "Nivel Educativo:", employee.EducationLevelDisplay));
        }

        private void ComposeProfessionalProfile(IContainer container, EmployeeViewModel employee)
        {
        ...
        private void ComposeContactData(IContainer container, EmployeeViewModel employee)
        {
            container.Column(column =>
            {
